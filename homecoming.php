			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
						...
						<p class="about-us x">
							We live our day to day lives oblivious to the beauty that surrounds us and by the time we do realise what exactly
							it is that we've been blessed with, it's generally too late. However when the good ol' days call yet again,
							nostalgia surrounds us as we walk the hallowed boulevards of our youth. The Homecoming brings to our alumni 
							a chance to reconnect with their Alma Mater..<br>
							<span><i class="fas fa-2x fa-hand-point-right pt-2"></i> The Homecoming 2020 will be organized for the batches of 2000, 2005 and 2010.</span>
						</p>
...
<section class="">		
	<div class="section-title container">
						...
						<div class="col-lg-6 pt-4 pt-lg-0 content text-center">
							...
							<p class="x">Homecoming 2019 reunited graduated KGPians with each other. They could reminiscence with their old friends 
	...
	<div class="section-title container">       
							<div class="row event-item">
							<div class="col-lg-6 pt-4 pt-lg-0 content text-center">
							<h3 class="pb-4 x" style="color:#EA1C2C;">2.2 Marathon</h3>
							<p class="x">The emblematic marathon track of our very own campus is enciting enough for everyone to keep aside their worries and run their problems off.With the alumni revisiting after a long time, the institute organizes a 2.2 marathon at the break of the day to bring back nostalgia and also to raise health awareness .Students and alumni run together to foster the spirit of harmony.
							</p>
						</div>
							<div class="col-lg-6 event-img x">
							<img src="img/imprint.jpg" class="img-fluid" alt="">
	...
	<div class="section-title container">       
							...
							<p class="x">Homecoming 2019 reunited graduated KGPians with each other. They could reminiscence with their old friends and relive those bonds they created many years ago. The conversations refreshed memories of friendships and comradery. The years old kgp life was now fresh on their minds.
							</p>
	...
	<div class="section-title container">       
							<div class="row event-item">
							<div class="col-lg-6 pt-4 pt-lg-0 content text-center">
							<h3 class="pb-4 x" style="color:#EA1C2C;">Campus Tour</h3>
							<p class="x">Homecoming 2019 reunited graduated KGPians with each other. They could reminiscence with their old friends and relive those bonds they created many years ago. The conversations refreshed memories of friendships and comradery. The years old kgp life was now fresh on their minds.
							</p>
	...
	<div class="section-title container">       
						...
						<div class="col-lg-6 pt-4 pt-lg-0 content text-center">
							...
							<p class="x">Evocative memories of slogging in labs, nicknaming teachers, fighting sleep, trying to learn. This place gave us few of our closest friends. More the time flew, more grew our attachment with this place. A visit back to department reminiscent all those feelings of hard work, procrastination, learning and excitement.
							</p>
