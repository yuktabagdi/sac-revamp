...
gsap.from(".Pre_Heads li",{scrollTrigger:".Pre_Heads",x:-700, duration: 2,opacity:0.2});
gsap.from(".Pre_Heads h4",{scrollTrigger:".Pre_Heads",x:-700, duration: 2,opacity:0.2});
