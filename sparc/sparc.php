...
<head>
    ...
    <style>
        body{
            background-color: rgba(108, 206, 236, 0.76);
        }
    </style>
</head>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#"><img src="imgs/sac_logo.png" style="height: 50px;"> </a>
    ...
    <section class="py-5">
        <div class="container-fluid content-box ">
            <div class="row py-5 px-4">
                <div class="col-md-6 col-xs-12 px-3 text">
                ...
                <div class="col-md-6 col-xs-12  content images">
                    <img src="https://source.unsplash.com/700x700/?students">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container-fluid content-box">
            <div class="row-xs-12 py-4 px-4 text" style="text-align: center;">
                <h1>Student Alumni Meet '17 - Mumbai</h1>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                </div>
    ...
    <section class="py-5">
        <div class="container-fluid content-box">
            <div class="row-xs-12 py-4 px-4 text" style="text-align: center;">
                <h1>Student Alumni Meet '16 - Banglore</h1>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                </div>
        ...
        <div class="container-fluid content-box">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12 px-4 py-4 text txt-final">
                        ...
                        great ideas
                        can be shared and improved and hence, executed.
                </div>
            </div>
        </div>
    </section>
